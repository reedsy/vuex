...
var Vuex = (function (vue) {
  ...
  var ApiProxy = function ApiProxy(plugin, hook) {
      ...
      if (hook) {
          hook.on(HOOK_PLUGIN_SETTINGS_SET, function (pluginId, value) {
              if (pluginId === this$1$1.plugin.id) {
                  this$1$1.fallbacks.setSettings(value);
              }
          });
      }
      this.proxiedOn = new Proxy({}, {
          get: function (_target, prop) {
              if (this$1$1.target) {
                  return this$1$1.target.on[prop];
              }
              else {
                  return function () {
      ...
      this.proxiedTarget = new Proxy({}, {
          get: function (_target, prop) {
              if (this$1$1.target) {
                  return this$1$1.target[prop];
              }
              else if (prop === 'on') {
                  return this$1$1.proxiedOn;
              }
              else if (Object.keys(this$1$1.fallbacks).includes(prop)) {
                  return function () {
                      var ref;

                      var args = [], len = arguments.length;
                      while ( len-- ) args[ len ] = arguments[ len ];
                      this$1$1.targetQueue.push({
                          method: prop,
                          args: args,
                          resolve: function () { },
                      });
                      return (ref = this$1$1.fallbacks)[prop].apply(ref, args);
                  };
              }
              else {
                  return function () {
  ...
  function registerGetters (store, getterKeys) {
    var computedObj = {};
    var computedCache = {};

    store._scope.run(function () {
      getterKeys.forEach(function (key) {
        var fn = store._wrappedGetters[key];
  ...
  Store.prototype.registerModule = function registerModule (path, rawModule, options) {
    ...
    var namespace = this._modules.getNamespace(path);
    var getterKeys = Object.keys(rawModule.getters || {}).map(function (key) { return namespace + key; });
