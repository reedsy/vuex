...
var Vuex = (function (vue) {
  ...
  function resetStoreState (store, state, hot) {
    ...
    var oldCache = store._computedCache;
    var oldGettersKeySet = new Set(store.getters ? Object.keys(store.getters) : []);
    ...
    if (oldScope) {
      var deadEffects = [];
      var staleComputedCache = new Set();
      oldGettersKeySet.forEach(function (staleKey) {
        staleComputedCache.add(oldCache[staleKey]);
      });
      oldScope.effects.forEach(function (effect) {
